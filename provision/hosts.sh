...
echo "192.168.141.103 pe-master.tenant.example.vm pe-master-tenant" >> /etc/hosts
echo "192.168.141.104 pe-puppetdb.tenant.example.vm pe-puppetdb-tenant" >> /etc/hosts
echo "192.168.141.105 pe-console.tenant.example.vm pe-console-tenant" >> /etc/hosts
